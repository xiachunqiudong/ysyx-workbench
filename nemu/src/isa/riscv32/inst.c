...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  * RV32M
  */
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , RR, R(rd) = (int64_t)src1 * (int64_t)src2);
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , RR, R(rd) = (word_t)(((int64_t)src1  * (int64_t)src2) >> 32));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , RR, R(rd) = (word_t)(((int64_t)src1  * (uint64_t)src2) >> 32));
