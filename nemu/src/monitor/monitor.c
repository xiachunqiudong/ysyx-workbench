...
static int parse_args(int argc, char *argv[]) {
  ...
  int o;
  // e: e选项后面需要有参数
  while ( (o = getopt_long(argc, argv, "-bhl:d:e:p:i:m:s:", table, NULL)) != -1) {
    switch (o) {
      ...
      case 's': syslog_file = optarg; break;
      ...
      default:
        ...
        printf("\t-s,--syslog=FILE        output syslog to FILE\n");
